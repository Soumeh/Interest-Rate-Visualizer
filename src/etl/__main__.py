...
from src.db.household.household_loans import HouseholdLoans
from src.db.household.household_term_deposits import HouseholdTermDeposits
from src.db.non_financial.non_financial_loans import NonFinancialLoans
from src.db.non_financial.non_financial_term_deposits_by_size import NonFinancialTermDepositsBySize
from src.db.total.total_loans import TotalLoans
from src.db.total.total_loans_by_currency import TotalLoansByCurrency
...
async def process_file(session: AsyncSession, url: str, sheet_name: str, table: type[SerializableTable]):
